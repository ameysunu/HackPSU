...
class IOwe extends StatefulWidget {
  @override
  _IOweState createState() => _IOweState();
}

class _IOweState extends State<IOwe> {
  @override
...
void newRecord() async {
  ...
  firestoreInstance.collection("users").doc('iowe').update({
...
Future<DocumentSnapshot> getUserInfo() async {
  var firebaseUser = await FirebaseAuth.instance.currentUser;
  return await FirebaseFirestore.instance.doc('users/iowe').get();
}
